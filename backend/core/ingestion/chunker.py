...
Extracts functions and classes as semantically complete chunks to ensure
accurate vector embeddings and retrieval context.

Supported languages: Python, JavaScript, TypeScript (including React).
"""
