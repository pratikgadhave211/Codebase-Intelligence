...
Downloads GitHub repositories via the GitHub API (ZIP format) to avoid
dependencies on the git binary in the runtime container.
"""
...
def clone_repo(
    ...
    try:
        ...
        print(f"[cloner.py] [OK] Successfully extracted '{repo_name}' to {local_path}")
        return {
            "status": "cloned",
