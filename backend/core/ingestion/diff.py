"""
Incremental Diff Module

Computes file-level diffs for incremental indexing. Compares the current file list
against previously stored file hashes to classify each file as added, modified,
